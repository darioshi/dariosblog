...
<head>
	...
	<title>Edit Article | Dario's Blog</title>
	...
	<div  class="col-md-9 " id="right_Content">
		<form action="/Blog/NewArticleServlet" method="post">
			...
			<table class="edit_table">
				...
				<tr>
					<td><b>分类</b></td>
					<td><input type="text"  id="sort" name="sort" style="width: 100px;" required value="${sort.name}">
				...
				<tr>
					<td><b>标签</b></td>
					<td>
						<input type="text" id="tags"  name="tags" style="width: 200px;" required value="<c:forEach var="tl" items="${tagList}" >${tl.name} </c:forEach>">
						<span style="float: left; margin-left: 10px;">
